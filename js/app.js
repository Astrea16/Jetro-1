...
let topSlider = new Swiper('.slider__top', {
	...
	// Arrows
	navigation: {
		nextEl: '.slider__arrows .slider__arrow--next',
		prevEl: '.slider__arrows .slider__arrow--prev',
	},
	thumbs: {
		swiper: bottomSlider,
	},
...
let slider_1 = new Swiper('.slider-1__body', {
	slidesPerView: 1,
	spaceBetween: 0,
	autoHeight: true,
	speed: 800,
	...
	navigation: {
		nextEl: '.slider-1__arrows .slider__arrow--next',
		prevEl: '.slider-1__arrows .slider__arrow--prev',
	},
...
let slider_2  = new Swiper('.slider-2__body', {
	observer: true,
	observeParents: true,
	effect: 'fade',
	spaceBetween: 0,
	...
	navigation: {
		nextEl: '.slider-2__arrows .slider__arrow--next',
		prevEl: '.slider-2__arrows .slider__arrow--prev',
	},
...
for (let filter of filters) {
	filter.addEventListener('click', function (e) {
		...
		let itemCat = document.querySelectorAll('.item-portfolio');

		itemCat.forEach(function (c) {
...
filterItem.forEach(item => {
	item.addEventListener('click', (e) => {
		filterItem.forEach(el => { el.classList.remove('_active'); });
...
let playBtn = document.querySelector('.controls__button');
let progressSlider = document.querySelector('controls__progress');
let progressFill = document.querySelector('.controls__filled');
let fullscreenBtn = document.querySelector('.controls__fullscreen');
